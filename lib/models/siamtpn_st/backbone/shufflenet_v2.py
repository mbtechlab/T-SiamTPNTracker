...
from lib.models.siamtpn_st.util import act_layers
...
class ShuffleV2Block(nn.Module):
    def __init__(self, inp, oup, stride, activation='ReLU',norm_layer=nn.BatchNorm2d):
    ...
    def __init__(self,
        ...
        for name, repeats, output_channels in zip(
            ...
            for i in range(repeats - 1):
                seq.append(ShuffleV2Block(output_channels, output_channels, 1, activation=activation, norm_layer=norm_layer))
