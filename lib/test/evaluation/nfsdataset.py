...
class NFSDataset(BaseDataset):
    ...
    def _get_sequence_info_list(self):
        sequence_info_list = [
            {"name": "nfs_Gymnastics", "path": "Gymnastics/240/Gymnastics", "startFrame": 1, "endFrame": 368, "nz": 5, "ext": "jpg", "anno_path": "Gymnastics/240/Gymnastics.txt", "object_class": "person", 'occlusion': False},
