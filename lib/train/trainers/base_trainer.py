...
class BaseTrainer:
    ...
    def __init__(self, actor, loaders, optimizer, settings, lr_scheduler=None):
        ...
        if next(self.actor.net.parameters()).is_cuda:
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    # print("djkfhdskfhihfkjdhgfhjdgfjhdkhdkhfkdhfkdfh")
                    self.train_epoch()
                    # print("djkfhdskfhihfkjdhgfhjdgfjhdkhdkhfkdhfkdfhretettrrterttry")
                    ...
                    if epoch > (max_epochs - 10) or save_every_epoch or epoch % 25 == 0:
    ...
    def load_state_dict(self, checkpoint=None):
        ...
        if next(self.actor.net.parameters()).is_cuda:
            ...
            print("Model is running on CPU")
        print("Keys in checkpoint: ", checkpoint_dict.keys())
        assert net_type == checkpoint_dict['net_type'], 'Network is not of correct type.'
